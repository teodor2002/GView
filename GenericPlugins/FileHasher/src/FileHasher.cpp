...
class FileHasher : public Window, public Handlers::OnButtonPressedInterface
{
  public:
    FileHasher() : Window("Character Table", "d:c,w:70,h:20", WindowFlags::Sizeable | WindowFlags::Maximized)
    {
